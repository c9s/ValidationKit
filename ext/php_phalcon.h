...
#define PHP_PHALCON_EXTNAME "validationkit"
...
ZEND_BEGIN_MODULE_GLOBALS(validationkit)
	phalcon_memory_entry *start_memory;
	phalcon_memory_entry *active_memory;
#ifndef PHALCON_RELEASE
	int phalcon_stack_stats;
#endif
ZEND_END_MODULE_GLOBALS(validationkit)

#ifdef ZTS
#include "TSRM.h"
#endif

ZEND_EXTERN_MODULE_GLOBALS(validationkit)

#ifdef ZTS
	#define PHALCON_GLOBAL(v) TSRMG(validationkit_globals_id, zend_validationkit_globals *, v)
#else
	#define PHALCON_GLOBAL(v) (validationkit_globals.v)
#endif

extern zend_module_entry validationkit_module_entry;
#define phpext_validationkit_ptr &validationkit_module_entry
